...
const enUS = {
    ...
    targetPathHint: 'Absolute path where skill files are synced for this IDE',
    ...
    msgNoTargetPath: 'No target path configured for "{0}". Please set a skill sync directory for this IDE.',
...
const zhCN: Record<TranslationKey, string> = {
    ...
    targetPathHint: '此 IDE 的技能文件同步绝对路径',
    ...
    msgNoTargetPath: '未为 "{0}" 配置目标路径，请设置此 IDE 的技能同步目录。',
